...
export const demoAccounts: DemoAccount[] = [
  {
    ...
    user: {
      ...
      email: 'admin@medicare.lk',
      role: 'admin',
      avatar: 'https://i.pravatar.cc/150?u=usr-admin-kumara',
  ...
  },
  {
    ...
    user: {
      ...
      email: 'doctor@medicare.lk',
      role: 'doctor',
      avatar: 'https://i.pravatar.cc/150?u=doc-nimal-perera',
  ...
  },
  {
    ...
    user: {
      ...
      email: 'reception@medicare.lk',
      role: 'receptionist',
      avatar: 'https://i.pravatar.cc/150?u=usr-reception-sachini',
